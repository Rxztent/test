...
//Remember to set isProd to true when putting on github :)
...
if(isProd) {
  ...
  imagePresetsFolder = 'presets-windows-symlink/';
  sharedUrl = 'https://raw.githubusercontent.com/DarkSnakeGang/GoogleSnakeLevelEditor/main/shared.js';
  randomHamUrl = 'http://localhost:3000/random_ham.txt';
  challengeUrl = 'http://localhost:3000/challenge.txt';
}
...
let customPresetManager = {
  ...
  importCode: function(fullCode) {
    ...
    //Then process the main part of the code.
...
function processMakePattern(code) {
  setupMakePatternHtml();
  ...
  (0,eval)(`
  function placeApple(x,y,type,initialSpeed=undefined,customProperties={}) {
  ...
  let wallDetailsContainer = code.match(/[$a-zA-Z0-9_]{0,6}&&\([$a-zA-Z0-9_]{0,6}\(this\.([$a-zA-Z0-9_]{0,6}),[$a-zA-Z0-9_]{0,6}\),[$a-zA-Z0-9_]{0,6}\(this\.settings,7\)/)[1];
  ...
  */
  //let [,placeWallFunc,wallCoordProperty,otherProperty1,fakeWallProperty,otherProperty2] = code.match(/([$a-zA-Z0-9_]{0,6})\(this,[a-z],{([$a-zA-Z0-9_]{0,6}):[a-z],([$a-zA-Z0-9_]{0,6}:!1,[$a-zA-Z0-9_]{0,6}:-1),([$a-zA-Z0-9_]{0,6}):!0,([$a-zA-Z0-9_]{0,6}:!0,[$a-zA-Z0-9_]{0,6}:void 0)}\)/);
  let [,placeWallFunc,wallCoordProperty,otherProperty1,fakeWallProperty,otherProperty2] = code.match(/([$a-zA-Z0-9_]{0,6})\(this,[a-z],{([$a-zA-Z0-9_]{0,6}):[a-z],([$a-zA-Z0-9_]{0,6}:!1),([$a-zA-Z0-9_]{0,6}):!0,([$a-zA-Z0-9_]{0,6}:!0)}\)/);

  //Make a function to place a wall
  (0,eval)(`
  function placeWall(x, y, banNeighbourSpawning = false) {
    x = Math.round(x);
    y = Math.round(y);
  ...
  let wallSet = code.match(/([$a-zA-Z0-9_]{0,6})\.set\([$a-zA-Z0-9_]{0,6}\([a-z]\),[a-z]\);/)[1];
  ...
  let funcWithPlaceWall = findFunctionInCode(code, /[$a-zA-Z0-9_]{0,6}=function\(a,b\)$/,
  ///[$a-zA-Z0-9_]{0,6}\([a-z],[a-z],{[$a-zA-Z0-9_]{0,6}:[a-z],[$a-zA-Z0-9_]{0,6}:!0,[$a-zA-Z0-9_]{0,6}:-1,[$a-zA-Z0-9_]{0,6}:!1,\n?[$a-zA-Z0-9_]{0,6}:![$a-zA-Z0-9_]{0,6}\([a-z]\.settings,11\),[$a-zA-Z0-9_]{0,6}:void 0}\);/,
  /[$a-zA-Z0-9_]{0,6}\([a-z],[a-z],{[$a-zA-Z0-9_]{0,6}:[a-z],[$a-zA-Z0-9_]{0,6}:!0,[$a-zA-Z0-9_]{0,6}:!1,\n?[$a-zA-Z0-9_]{0,6}:![$a-zA-Z0-9_]{0,6}\([a-z]\.settings,11\)}\);/,
  false);
  ...
  eval(funcWithPlaceWall);

  document.getElementsByClassName('oGdex JWsmhb')[0].style.filter = 'sepia(50%)';

  let sokoDetailsContainer = code.match(/this\.([$a-zA-Z0-9_]{0,6})\.reset\(\);if\([$a-zA-Z0-9_]{0,6}\(this\.settings,8\)/)[1];

  //Setup for placing sokoban boxes
  //let [,sokoboxSet, sokoPosition, sokoOtherProperties] = code.match(/[a-z]\.([$a-zA-Z0-9_]{0,6})\.add\({([$a-zA-Z0-9_]{0,6}):[a-z],prev:null,([$a-zA-Z0-9_]{0,6}:!0,[$a-zA-Z0-9_]{0,6}:-1,[$a-zA-Z0-9_]{0,6}:!0)}\)/);
  let [,sokoboxSet, sokoPosition, sokoOtherProperties] = code.match(/[a-z]\.([$a-zA-Z0-9_]{0,6})\.add\({([$a-zA-Z0-9_]{0,6}):[a-z],prev:null,([$a-zA-Z0-9_]{0,6}:!0,[$a-zA-Z0-9_]{0,6}:!0)}\)/);

  //Make a function to place a sokobox
  (0,eval)(`
  function placeSokobox(x,y) {
    x = Math.round(x);
    y = Math.round(y);
  ...
  let sokogoalSet = code.match(/[$a-zA-Z0-9_]{0,6}\([a-z]\.settings,\n?7\)&&[a-z]\.([$a-zA-Z0-9_]{0,6})\.add\([$a-zA-Z0-9_]{0,6}\([a-z]\.[$a-zA-Z0-9_]{0,6},\n?[a-z]\)\)\)/)[1];

  //Make a function that removes sokoban goals
  (0,eval)(`
  function emptySokogoals(x,y) {
  ...
  let funcWithSnakeStartPos = findFunctionInCode(code, /[$a-zA-Z0-9_]{0,6}\.prototype\.reset=function\(\)$/,
    /this\.[$a-zA-Z0-9_]{0,6}\.push\(new [$a-zA-Z0-9_]{0,6}\(Math\.floor\(this\.[$a-zA-Z0-9_]{0,6}\.[$a-zA-Z0-9_]{0,6}\.width\/4\),Math\.floor\(this\.[$a-zA-Z0-9_]{0,6}\.[$a-zA-Z0-9_]{0,6}\.height\/2\)\)\);/,
    false);

  funcWithSnakeStartPos = assertReplace(funcWithSnakeStartPos,
    /this\.([$a-zA-Z0-9_]{0,6})\.push\(new [^]*3,Math\.floor\(this\.[$a-zA-Z0-9_]{0,6}\.[$a-zA-Z0-9_]{0,6}\.height\/2\)\)\);/,
  ...
  eval(funcWithSnakeStartPos);

  //Func used to change settings in the menu
  let funcWithChangeSetting = findFunctionInCode(code, /[$a-zA-Z0-9_]{0,6}=function\(a,b,c,d\)$/,
  /case "apple":[a-z]\.settings\.[$a-zA-Z0-9_]{0,6}=[a-z];break;/,
  false);

  //Just need the name of this function so we can call it.
  window.changeSettingFuncName = /[$a-zA-Z0-9_]{0,6}/.exec(funcWithChangeSetting)[0];

  //Func used to do a full reset (simulating click play from menu button?)
  let funcWithFullReset = findFunctionInCode(code, /[$a-zA-Z0-9_]{0,6}=function\(\)$/,
  /if\(this\.menu\.isVisible\(\)\|\|this\.[$a-zA-Z0-9_]{0,6}\.[$a-zA-Z0-9_]{0,6}\)/,
  false);

  //Just need the name of this function so we can call it.
  window.fullResetFuncName = /[$a-zA-Z0-9_]{0,6}/.exec(funcWithFullReset)[0];
...
function setPixelData(target, url, callback = null) {
...
function blitPattern(pixelList, offsetX=0, offsetY=0) {
...
*/
function hexToPixelDetails(hex) {
  hex = hex.toUpperCase();
...
function setupMakePatternHtml() {
  ...
  myCustomEl.style = window.location.href.includes('fbx') ? 'position: absolute; left: calc(100% + 200px);z-index:1001;' : 'position: absolute; right: 100%;z-index:1001;';
  ...
  if(window.location.href.includes('fbx')) {
...
function selectNewSizeSettingAndHardReset(newSizeSetting) {
  //Change size setting
  if(typeof wholeSnakeObject !== 'undefined' && newSizeSetting !== null) {
    let sizeEl = document.getElementById('size');
    window[changeSettingFuncName](wholeSnakeObject.menu,sizeEl,true,newSizeSetting);

    //Also need to reposition the centralise the selected size in the menu. This is quite hacky.
